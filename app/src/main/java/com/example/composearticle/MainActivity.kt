...
fun ComposeArticleApp(){
    ComposeArticle(
            ...
            subHeader = "Jetpack Compose is a modern toolkit for building native Android UI. Compose simplifies and accelerates UI development on Android with less code, powerful tools, and intuitive Kotlin APIs",
...
@Composable
fun ComposeArticle(title: String, subHeader: String, content: String) {
